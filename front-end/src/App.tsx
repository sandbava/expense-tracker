...
import {type ExpenseFormData} from "./expense-tracker/components/ExpenseForm";
    ...
    return (
        <div>
            <>
                ...
                />
                <button className="btn btn-outline-warning" onClick={() => setExpenses(defaultExpenses)}>
                    Restore default expenses list
                </button>
            </>
